...
// EncodeMulResponse returns an encoder for responses returned by the calc mul
// endpoint.
...
// DecodeMulRequest returns a decoder for requests sent to the calc mul
// endpoint.
